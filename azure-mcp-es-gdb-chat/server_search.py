...
def create_server():
    ...
    async def search(query: str) -> Dict[str, List[Dict[str, Any]]]:
        ...
        print(f"Searching {VECTOR_STORE_ID} for query: '{query}'")

        #response = openai_client.vector_stores.search(
        #    vector_store_id=VECTOR_STORE_ID, query=query)

        results = [{"results": [{"id": "1", "title": "Document 1", "text": "Content 1", "url": "https://www.google.com"}]}]
    ...
    async def fetch(id: str) -> Dict[str, Any]:
        ...
        """
        print(f"Fetching content from vector store for file ID: {id}")
        if not id:
        ...
        return {
            "id": id,
            "title": "elfilechido",
            "text": "el contenido del filechido",
            "url": f"https://platform.openai.com/storage/files/{id}",
            "metadata": "el metadata del filechido"
        }
        """
